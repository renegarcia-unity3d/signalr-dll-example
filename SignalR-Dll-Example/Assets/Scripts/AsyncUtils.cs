...
namespace Microsoft.Unity
{
	...
	public class ExceptionSafeRoutine<TResult> : IEnumerator
	{
		...
		TaskCompletionSource<TResult> m_ExceptionSource;
		...
		public object Current
		{
			get
			{
				...
				{
					m_ExceptionSource.TrySetException(ex);
					return null;
				}
			}
		}
	...
	public static class AsyncUtils
	{
		...
		/// </param>
		static void LogError(Behaviour behaviour, Exception ex, bool disable)
		{
			// Get names
		...
		/// </param>
		public static async void RunSafeVoid(this Behaviour behaviour, Func<Task> task, BehaviourErrorHandler onError)
		{
		...
		/// </param>
		public static void RunSafeVoid(this Behaviour behaviour, Func<Task> task, bool disableOnError = true)
		{
		...
		/// </param>
		/// <returns></returns>
		public static IEnumerator WithExceptionHandling<TResult>(this IEnumerator coroutine, TaskCompletionSource<TResult> exceptionSource)
		{
